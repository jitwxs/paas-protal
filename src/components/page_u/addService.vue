<template>
  <div id="main">
    ...
    <h4 style="text-align: center;margin-bottom: 30px;font-size: 22px;">创&nbsp;&nbsp;建&nbsp;&nbsp;服&nbsp;&nbsp;务</h4>
    ...
    <el-form :label-position="labelPosition" label-width="100px" :model="service" class="serviceForm">
      ...
      <el-form-item label="镜像">
        ...
        <el-col :span="10" >
          <el-select placeholder="请选择image来源" style="width: 100%"  @change="changeValue"  v-model="label">
            <el-option v-for="item in Registry" :key="item.id" :label="item.label" :value="item.id"></el-option>
          </el-select>
        </el-col>
      </el-form-item>
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-button
                    size="mini"
                    @click="downloadImage('docker', scope.row.name,scope.row.name)" type="success">下载</el-button>
                </template>
              </el-table-column>
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-button
                    size="mini"
                    @click="downloadImage('pass',scope.row.id,scope.row.name)" type="success">下载</el-button>
                </template>
              </el-table-column>
            </el-table>
      ...
      >
        <el-col :span="11"> <el-input v-model="envItem.value"></el-input></el-col>
        <el-col :span="3" :offset="1"> <el-button @click.prevent="del('env',envItem)">删除</el-button></el-col>
      </el-form-item>
      ...
      >
        <el-col :span="11"> <el-input v-model="cmdItem.value"></el-input></el-col>
        <el-col :span="3" :offset="1"> <el-button @click.prevent="del('cmd',cmdItem)">删除</el-button></el-col>
      </el-form-item>
      ...
      >
        <el-col :span="11"> <el-input v-model="destinationItem.value"></el-input></el-col>
        <el-col :span="3" :offset="1"> <el-button @click.prevent="del('destination',destinationItem)">删除</el-button></el-col>
      </el-form-item>
      ...
      >
        ...
        <el-col :span="3" > <el-button @click.prevent="del('port',portItem)" v-if="index >=initPortLength">删除</el-button></el-col>
      </el-form-item>
      ...
      >
        ...
        <el-col :span="3" > <el-button @click.prevent="del('labels',labelsItem)" >删除</el-button></el-col>
      </el-form-item>

      <el-form-item label="横向扩展数">
        <el-col :span="12">
          <el-input-number v-model="service.replicas" @change="replicasChange" :min="1" :max="10" ></el-input-number>
